...
var nicEditor = bkClass.extend({
	...
	panelInstance : function(e,o) {
		...
		var panelElm = new bkElement('DIV').setStyle({width : (((e != null && e != 'undefined')? (parseInt(e.getStyle('width')) || e.clientWidth):'0'))+'px'}).appendBefore(e);
...
var nicEditorFontFamilySelect = nicEditorSelect.extend({
	sel : {'arial' : 'Arial','courier new' : 'Courier New','times new roman' : 'Times','verdana' : 'Verdana', 'Akronim' : 'Akronim', 'Cambo' : 'Cambo', 'DiplomataSC' : 'DiplomataSC', 'Engagement' : 'Engagement', 'Fenix' : 'Fenix', 'FugazOne' : 'FugazOne', 'Lemon' : 'Lemon', 'LindenHill' : 'LindenHill', 'NewRocker' : 'NewRocker', 'Playball' : 'Playball', 'PT_Serif-Caption-Web' : 'PT_Serif-Caption-Web', 'Stalemate' : 'Stalemate'},
...
var nicUploadButton = nicEditorAdvancedButton.extend({	
  ...
  uploadFile : function() {
    ...
    xhr.open("POST", this.nicURI,true);
